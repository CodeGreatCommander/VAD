...
private:
    ...
    void init_onnx_model(const std::wstring& model_path)
    {
        ...
        session = std::make_shared<Ort::Session>(env, model_path.c_str(), model_path.length(), session_options);
...
int main()
{
    ...
    // Read wav
    wav::WavReader wav_reader("/home/rohan/VAD/inference/silero_vad/trial.wav"); //16000,1,32float
