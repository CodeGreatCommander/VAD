...
#include <map>
#include <string>
#include "/home/rohan/VAD/inference/pynote/complete_work/model/sincnet/sincnet.cpp"
...
namespace PyanNet{
    ...
    class PyanNet:public torch::nn::Module{
        ...
        PyanNet(int64_t sample_rate=1600, int64_t num_channels=1) {
            ...
            sincnet = register_module("sincnet", std::make_shared<sincnet::SincNet>());
        ...
        private:
            ...
            std::shared_ptr<sincnet::SincNet> sincnet{ nullptr };
